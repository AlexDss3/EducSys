...
class UnidadesModel extends CI_Model{
	...
	public function ListarContenidos($idUnidad){
		...
		WHERE unidades.idUnidad = contenidos.idUnidad and contenidos.idUnidad = $idUnidad and unidades.idUnidad = $idUnidad order by contenidos.correlativo");
	}
